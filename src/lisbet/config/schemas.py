...
class DataAugmentationConfig(BaseModel):
    ...
    Attributes:
        name: Name of the augmentation technique (all_perm_id, all_perm_ax, blk_perm_id, all_translate, all_mirror_x, all_zoom, gauss_jitter, blk_gauss_jitter, kp_ablation, blk_kp_ablation)
        p: Probability of applying this transformation (0.0 to 1.0)
        frac: Fraction of frames to permute (only block-based augmentations, 0.0 to 1.0 exclusive)
